...
ObjectPool<X> pools = ObjectPool<X>.GetInstance; //Singleton pool olmalıdır heryerden aynı havuza ulasmak lazım değilse poola eleman eklemenın bır manası kalmaz
...
Console.WriteLine();
class ObjectPool<T> where T : class //sigleton uygulncak
{
